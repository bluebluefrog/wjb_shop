    ...
    <div class="container mt-2 p-2 m-0" style="background-color:rgb(127, 125, 121)">
        <div class="row">
            ...
            <div class="col-8 pt-2 mb-2 pl-0">
                <h6 class="text-white">${shop.shopName}</h6>
                <div class="p-1 alert alert-warning small" role="alert">
                    ${shop.subTitle}
                </div>
                <p class="mb-1">
                    <span class="text-white-50 small">${shop.owner}</span>
                </p>
        ...
        <div class="row" style="background-color: rgba(0,0,0,0.1);">
            <div class="col-2"><h2 class="text-white">${shop.evaluationScore}</h2></div>
            <div class="col-5 pt-2">
                <span class="stars" data-score="${shop.evaluationScore}"></span>
            </div>
            <div class="col-5  pt-2"><h5 class="text-white">${shop.evaluationQuantity}人已评</h5></div>
        </div>
    </div>
